...
(:init
    ...
    (destination p1 Gibraltar)
    (destination p2 Almeria)
    (destination p3 Madrid)
    (destination p4 Gibraltar)
    (destination p5 Gibraltar)
    (destination p6 Granada)
    (destination p7 Gibraltar)
    (destination p8 Gibraltar)
    (destination p9 Granada)
    (destination p10 Bilbao)
    (destination p11 Madrid)
    (destination p12 Madrid)
    (destination p13 Madrid)
    (destination p14 Gibraltar)
    (destination p15 Gibraltar)
    (destination p16 Granada)
    (destination p17 Gibraltar)
    (destination p18 Gibraltar)
    (destination p19 Granada)
    (destination p20 Bilbao)
 )
