...
(:OBJECTS
    ...
    PLAYER - Player
    OSCAR APPLE ROSE ALG GOLD BIKINI SHOE  - Objc
...
(:goal
    (and (DeliveredObj DICAPRIO OSCAR) (DeliveredObj PRINCESS ROSE) (DeliveredObj WITCH APPLE) (DeliveredObj PROF ALG) (DeliveredObj PRINCE GOLD)))
